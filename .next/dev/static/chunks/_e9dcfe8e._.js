...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        const handleLogin = async ()=>{
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAPI"])("/user/login", {
                    method: "POST",
                    body: JSON.stringify({
                        email,
                        password
...
//# sourceMappingURL=_e9dcfe8e._.js.map