...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/user/login", {
                email,
                password
            });
            if (data?.token) {
...
//# sourceMappingURL=_3bc8697e._.js.map